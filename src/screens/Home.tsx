  ...
  return (
    <View
      ...
      <View style={styles.titleContainer}>
        <Text
          style={[styles.headerTxt, {color: isDarkTheme ? '#fff' : '#000'}]}>
          HomeScreen
        </Text>
        <Switch
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(item?.screen as keyof RootStackListProp)
            }>
            <Text
              style={[styles.topicTxt, {color: isDarkTheme ? 'red' : '#000'}]}>
              {item.title}
            </Text>
          </TouchableOpacity>
        )}
